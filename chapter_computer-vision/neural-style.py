...
def _():
    ...
    return content_img, d2l, nn, torch, torchvision
...
@app.cell
def _(content_layers, nn, pretrained_net, style_layers):
...
def _(
    ...
    return get_contents, get_styles
...
@app.cell
def _(content_loss, style_loss, tv_loss):
...
@app.cell
def _(SynthesizedImage, gram, torch):
...
@app.cell
def _(d2l, get_contents, get_styles, net, train):
