...
@app.cell
def _(d2l, data_dir, nn, os, test_augs, torch, torchvision, train_augs):
...
@app.cell
def _(finetune_net, train_fine_tuning):
...
@app.cell
def _(nn, torchvision, train_fine_tuning):
