...
def _():
    ...
    return d2l, nn, torch, torchvision
...
@app.cell
def _(apply, color_aug, img, shape_aug, torchvision):
...
def _(d2l):
    ...
    return (train_batch_ch13,)


@app.cell
def _(d2l, nn, train_batch_ch13):
    #@save
...
@app.cell
def _(d2l, load_cifar10, nn, torch, train_ch13):
    ...
    return net, train_with_data_aug
...
@app.cell
def _(net, test_augs, train_augs, train_with_data_aug):
