...
def _(torch):
    ...
    return box_center_to_corner, box_corner_to_center
...
@app.cell
def _(box_center_to_corner, box_corner_to_center, cat_bbox, dog_bbox, torch):
...
@app.cell
def _(bbox_to_rect, cat_bbox, d2l, dog_bbox, img):
