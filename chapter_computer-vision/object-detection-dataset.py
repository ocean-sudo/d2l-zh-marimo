...
def _():
    ...
    return d2l, os, pd, torch, torchvision
...
@app.cell
def _(d2l, os, pd, torch, torchvision):
    #@save
...
@app.cell
def _(load_data_bananas):
    batch_size, edge_size = 32, 256
    train_iter, _ = load_data_bananas(batch_size)
    batch = next(iter(train_iter))
    batch[0].shape, batch[1].shape
    return batch, edge_size
