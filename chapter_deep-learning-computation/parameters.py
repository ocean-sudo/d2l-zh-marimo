...
def _(X, nn):
    ...
    net_1 = nn.Sequential(nn.Linear(4, 8), nn.ReLU(), shared, nn.ReLU(), shared, nn.ReLU(), nn.Linear(8, 1))
    net_1(X)
    print(net_1[2].weight.data[0] == net_1[4].weight.data[0])
    net_1[2].weight.data[0, 0] = 100
    # 检查参数是否相同
