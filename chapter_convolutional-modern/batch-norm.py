...
def _():
    ...
    return batch_norm, d2l, nn, torch
...
def _(d2l, net):
    ...
    return lr, num_epochs, test_iter, train_iter
...
@app.cell
def _(d2l, lr, net_1, num_epochs, test_iter, train_iter):
    d2l.train_ch6(net_1, train_iter, test_iter, num_epochs, lr, d2l.try_gpu())
    return
