...
def _():
    ...
    return conv_block, d2l, nn, torch
...
@app.cell
def _(DenseBlock, torch):
    _blk = DenseBlock(2, 3, 10)
...
@app.cell
def _(Y, transition_block):
    _blk = transition_block(23, 10)
    _blk(Y).shape
    return
...
@app.cell
def _(DenseBlock, transition_block):
    # num_channels为当前的通道数
