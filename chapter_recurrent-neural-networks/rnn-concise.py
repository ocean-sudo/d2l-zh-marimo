...
def _():
    ...
    return F, batch_size, d2l, nn, num_steps, torch, train_iter, vocab
...
@app.cell
def _(batch_size, num_hiddens, torch):
...
@app.cell
def _(batch_size, num_steps, rnn_layer, state, torch, vocab):
...
@app.cell
def _(RNNModel, d2l, rnn_layer, vocab):
    device = d2l.try_gpu()
...
@app.cell
def _(d2l, device, net, train_iter, vocab):
    num_epochs, lr = 500, 1
