...
@app.cell
def _(RNNModelScratch, X, d2l, get_params, init_rnn_state, rnn, vocab):
    num_hiddens = 512
...
@app.cell
def _(d2l, net, predict_ch8, vocab):
...
@app.cell
def _(d2l, grad_clipping, math, nn, torch):
    #@save
...
@app.cell
def _(d2l, nn, predict_ch8, torch, train_epoch_ch8):
    #@save
...
@app.cell
def _(d2l, net, train_ch8, train_iter, vocab):
    num_epochs, lr = 500, 1
...
def _(
    ...
    net_1 = RNNModelScratch(len(vocab), num_hiddens, d2l.try_gpu(), get_params, init_rnn_state, rnn)
    train_ch8(net_1, train_iter, vocab, lr, num_epochs, d2l.try_gpu(), use_random_iter=True)
    return
