...
def _(d2l, math):
    def adagrad_2d(x1, x2, s1, s2):
        ...
        s1 += g1 ** 2
        s2 += g2 ** 2
        x1 -= _eta / math.sqrt(s1 + eps) * g1
        x2 -= _eta / math.sqrt(s2 + eps) * g2
        return (x1, x2, s1, s2)
...
def _(torch):
    ...
    return adagrad, init_adagrad_states
...
@app.cell
def _(adagrad, d2l, init_adagrad_states):
