...
def _():
    ...
    def gd_2d(x1, x2, s1, s2):
        return (x1 - _eta * 0.2 * x1, x2 - _eta * 4 * x2, 0, 0)
    d2l.show_trace_2d(f_2d, d2l.train_2d(gd_2d))
    return d2l, f_2d, gd_2d, torch
...
def _(d2l, f_2d):
    def momentum_2d(x1, x2, v1, v2):
        v1 = _beta * v1 + 0.2 * x1
        v2 = _beta * v2 + 4 * x2
        return (x1 - _eta * v1, x2 - _eta * v2, v1, v2)
    _eta, _beta = (0.6, 0.5)
...
def _(d2l, torch):
    ...
    for _beta in betas:
        ...
        d2l.plt.plot(x, _beta ** x, label=f'beta = {_beta:.2f}')
    d2l.plt.xlabel('time')
    d2l.plt.legend()
    return
...
@app.cell
def _(d2l, init_momentum_states, sgd_momentum):
    ...
    return data_iter, train_momentum
...
def _(d2l, torch):
    ...
    for lam in lambdas:
        ...
        d2l.plt.plot(t, (1 - _eta * lam) ** t, label=f'lambda = {lam:.2f}')
    d2l.plt.xlabel('time')
    d2l.plt.legend()
    return
