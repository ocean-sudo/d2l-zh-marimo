...
def _():
    ...
    return d2l, nn, torch, train_iter, vocab
...
@app.cell
def _(d2l, get_lstm_params, init_lstm_state, lstm, train_iter, vocab):
    vocab_size, num_hiddens, device = (len(vocab), 256, d2l.try_gpu())
    num_epochs, lr = (500, 1)
    _model = d2l.RNNModelScratch(len(vocab), num_hiddens, device, get_lstm_params, init_lstm_state, lstm)
    d2l.train_ch8(_model, train_iter, vocab, lr, num_epochs, device)
    return device, lr, num_epochs, num_hiddens, vocab_size
...
def _(
    ...
    _model = d2l.RNNModel(lstm_layer, len(vocab))
