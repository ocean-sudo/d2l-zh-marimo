...
def _(text):
    ...
    source[:6], target[:6]
    return source, target, tokenize_nmt
...
@app.cell
def _(build_array_nmt, d2l, preprocess_nmt, read_data_nmt, tokenize_nmt):
    #@save
...
@app.cell
def _(load_data_nmt, torch):
    train_iter, src_vocab_1, tgt_vocab = load_data_nmt(batch_size=2, num_steps=8)
