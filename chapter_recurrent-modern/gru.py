...
@app.cell
def _(d2l, get_params, gru, init_gru_state, train_iter, vocab):
    vocab_size, num_hiddens, device = (len(vocab), 256, d2l.try_gpu())
    num_epochs, lr = (500, 1)
    _model = d2l.RNNModelScratch(len(vocab), num_hiddens, device, get_params, init_gru_state, gru)
...
def _(
    ...
    _model = d2l.RNNModel(gru_layer, len(vocab))
