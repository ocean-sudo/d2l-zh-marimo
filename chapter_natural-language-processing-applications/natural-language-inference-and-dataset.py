...
def _():
    ...
    return d2l, data_dir, os, re, torch
...
@app.cell
def _(data_dir, read_snli, train_data):
...
@app.cell
def _(SNLIDataset, d2l, read_snli, torch):
    #@save
