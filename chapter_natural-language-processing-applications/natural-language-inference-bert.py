...
def _():
    ...
    return d2l, json, multiprocessing, nn, os, torch
...
@app.cell
def _(d2l, load_pretrained_model):
    devices = d2l.try_all_gpus()
    bert, vocab = load_pretrained_model(
        'bert.small', num_hiddens=256, ffn_num_hiddens=512, num_heads=4,
        num_layers=2, dropout=0.1, max_len=512, devices=devices)
    return bert, devices, vocab
...
@app.cell
def _(d2l, multiprocessing, torch):
...
@app.cell
def _(SNLIBERTDataset, d2l, torch, vocab):
