...
@app.cell
def _(Aggregate, Attend, Compare, nn):
...
def _(d2l):
    ...
    return test_iter, train_iter, vocab
...
@app.cell
def _(DecomposableAttention, d2l, vocab):
