...
def _(d2l, torch):
    ...
    return batch_size, num_inputs, test_iter, train_iter
...
@app.cell
def _(batch_size, d2l, init_params, l2_penalty, test_iter, torch, train_iter):
    def train(lambd):
        w, b = init_params()
...
@app.cell
def _(d2l, nn, num_inputs, test_iter, torch, train_iter):
