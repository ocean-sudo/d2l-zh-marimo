...
@app.cell
def _(devices, loss, net, train_bert, train_iter, vocab):
...
@app.cell
def _(d2l, devices, torch, vocab):
    def get_bert_encoding(net, tokens_a, tokens_b=None):
        tokens, segments = d2l.get_tokens_and_segments(_tokens_a, tokens_b)
...
@app.cell
def _(get_bert_encoding, net):
    _tokens_a = ['a', 'crane', 'is', 'flying']
    encoded_text = get_bert_encoding(net, _tokens_a)
...
@app.cell
def _(get_bert_encoding, net):
    _tokens_a, tokens_b = (['a', 'crane', 'driver', 'came'], ['he', 'just', 'left'])
    encoded_pair = get_bert_encoding(net, _tokens_a, tokens_b)
